        ...
        <div className={styles.contentbox}>
            ...
            <div className={styles.contentall}>
                <div className={styles.contentdetail}>
                    ...
                    <div className={styles.detailbox}>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba1.jpg"><img src="/haba1.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba2.jpg"><img src="/haba2.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba4.jpg"><img src="/haba4.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba5.jpg"><img src="/haba5.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba6.jpg"><img src="/haba6.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Photography directing and Design, 2018" href="/haba7.jpg"><img src="/haba7.jpg" className={styles.detailimg1} alt="HABA Advertisement"/></a>
                    ...
                    <div className={styles.detailbox}>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl1.jpg"><img src="/fancl1.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl1-1.jpg"><img src="/fancl1-1.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl1-2.jpg"><img src="/fancl1-2.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl2.jpg"><img src="/fancl2.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl2-1.jpg"><img src="/fancl2-1.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl3.jpg"><img src="/fancl3.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl3-1.jpg"><img src="/fancl3-1.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl4.jpg"><img src="/fancl4.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Photography directing and Design, 2019" href="/fancl5.jpg"><img src="/fancl5.jpg" className={styles.detailimg1} alt="FANCL Advertisement"/></a>
                    ...
                    <div className={styles.detailbox}>
                        <a className={styles.detail} data-fancybox="images-j" data-caption="JustBB, Mask Pack Package Series, Design and Illustration, 2014" href="/justbbmask2.jpg"><img src="/justbbmask2.jpg" className={styles.detailimg1} alt="Just BB"/></a>
                        <a className={styles.detail} data-fancybox="images-j" data-caption="JustBB, Mask Pack Package Series, Design and Illustration, 2014" href="/justbbmask3.jpg"><img src="/justbbmask3.jpg" className={styles.detailimg1} alt="Just BB"/></a>
                    ...
                    <div className={styles.detailbox}>
                        <a className={styles.detail} data-fancybox="images-k" data-caption="KIMS, Brand Logo, Character and print meterial Desgin, Design, 2011" href="/koreawave5.jpg"><img src="/koreawave5.jpg" className={styles.detailimg1} alt="Korea Wave Branding"/></a>
                        <a className={styles.detail} data-fancybox="images-k" data-caption="KIMS, Brand Logo, Character and print meterial Desgin, Design, 2011" href="/koreawave4.jpg"><img src="/koreawave4.jpg" className={styles.detailimg1} alt="Korea Wave Branding"/></a>
                        <a className={styles.detail} data-fancybox="images-k" data-caption="KIMS, Brand Logo, Character and print meterial Desgin, Design, 2011" href="/koreawave3.png"><img src="/koreawave3.png" className={styles.detailimg1} alt="Korea Wave Branding"/></a>
                        <a className={styles.detail} data-fancybox="images-k" data-caption="KIMS, Brand Logo, Character and print meterial Desgin, Design, 2011" href="/koreawave2.jpg"><img src="/koreawave2.jpg" className={styles.detailimg1} alt="Korea Wave Branding"/></a>
