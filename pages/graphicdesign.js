            ...
            <div className={styles.contentall}>
                <div className={styles.contentdetail}>
                    ...
                    <div className={styles.detailbox}>
                        ...
                        <a className={styles.detail} data-fancybox="images-f" data-caption="Fancl, Cosmetic Advertisement, Create concepts for Photography and Design, 2019" href="/fancl6.jpg"><img src="/fancl6.jpg" className={styles.detailimg} alt="FANCL Advertisement"/>FANCL.zip</a>
                    </div>
                    <div className={styles.detailbox}>
