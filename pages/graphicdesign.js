            ...
            <div className={styles.contentall}>
                <div className={styles.contentdetail}>
                    ...
                    <div className={styles.detailbox}>
                        ...
                        <a className={styles.detail} data-fancybox="images-h" data-caption="Haba, Cosmetic Advertisement, Create concepts for Photography and Design, 2018" href="/haba3.jpg" href="/haba_exp.png"><img src="/haba3.jpg" className={styles.detailimg} alt="HABA Advertisement"/>HABA.zip</a>
                    </div>
                    <div className={styles.detailbox}>
