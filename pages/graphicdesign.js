            ...
            <div className={styles.contentall}>
                <div className={styles.contentdetail}>
                    <div className={styles.detailbox}>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro3.jpg"><img src="/screenpro3.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro2.jpg"><img src="/screenpro2.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro4.jpg"><img src="/screenpro4.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro6.jpg"><img src="/screenpro6.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro5.jpg"><img src="/screenpro5.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro7.jpg"><img src="/screenpro7.jpg" className={styles.detailimg1} alt="Screenpro Security advertising design"/></a>
                        <a className={styles.detail} data-fancybox="images-sp" data-caption="Screenpro Security, Web advertisement and marketing material, Design, 2021" href="/screenpro_explain.jpg"><img src="/screenpro_thum.jpg" className={styles.detailimg} alt="Screenpro Security advertising design"/>Screenpro Security.zip</a>
                    </div>
                    <div className={styles.detailbox}>
